...
DataForm.prototype.collectionGet = function () {
    return _.bind(function (req, res, next) {
        ...
        try {
            var aggregationParam = urlParts.query.a ? JSON.parse(urlParts.query.a) : undefined;
            var findParam = urlParts.query.f ? JSON.parse(urlParts.query.f) : undefined;
            var limitParam = urlParts.query.l ? JSON.parse(urlParts.query.l) : undefined;
            var skipParam = urlParts.query.s ? JSON.parse(urlParts.query.s) : undefined;
...
DataForm.prototype.entityPut = function () {
    return _.bind(function (req, res, next) {
        ...
        var cleansedBody = this.cleanseRequest(req), that = this;
        // Merge
